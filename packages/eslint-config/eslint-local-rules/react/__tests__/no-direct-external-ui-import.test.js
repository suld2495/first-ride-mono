...
test('no-direct-external-ui-import only checks component layers', () => {
  ruleTester.run('no-direct-external-ui-import/component-scope', rule, {
    valid: [
      {
      ...
      },
      {
        ...
        filename: 'theme/tamagui.config.ts',
        settings: nativeLayerSettings,
      },
      {
