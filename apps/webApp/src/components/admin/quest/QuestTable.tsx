...
import {
  formatQuestPeriod,
  truncateQuestName,
} from '@repo/shared/utils/quest-utils';
      ...
      <table className="w-full border-collapse">
        <thead>
          <tr className="border-b-[1px] border-gray-300 dark:border-gray-600">
            ...
            <th className="p-3 text-left text-gray-main dark:text-gray-200">
              <Paragraph>퀘스트명</Paragraph>
            </th>
            <th className="p-3 text-left text-gray-main dark:text-gray-200">
              <Paragraph>타입</Paragraph>
            </th>
            <th className="p-3 text-left text-gray-main dark:text-gray-200">
              <Paragraph>기간</Paragraph>
            </th>
            <th className="p-3 text-left text-gray-main dark:text-gray-200">
              <Paragraph>레벨</Paragraph>
            </th>
            <th className="p-3 text-left text-gray-main dark:text-gray-200">
            ...
            >
              ...
              >
                <Paragraph className="hover:underline">
                  {truncateQuestName(quest.questName, 20)}
                </Paragraph>
              </td>
              <td className="p-3">
                <span
                  className={`px-2 py-1 rounded text-xs ${getQuestTypeBadgeClass(quest.questType)}`}
                >
                  {quest.questType}
                </span>
              </td>
              ...
              <td className="p-3 text-gray-main dark:text-gray-200">
                <Paragraph>{quest.requiredLevel}</Paragraph>
              </td>
              <td className="p-3">
                <div className="flex gap-2">
                  <Button size="small" onClick={() => onEdit(quest)}>
                    수정
                  </Button>
                  <Button
                    size="small"
